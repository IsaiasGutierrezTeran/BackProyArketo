    ...
    *,
    ...
    try:
        ...
        try:
            ...
            Exception
        ):  # noqa: BLE001 — IA externa falló (429/cuota/red): usar el mock
        ...
        Exception
    ) as exc:  # noqa: BLE001 — cualquier fallo no controlado deja FAILED, no PENDING
        request.status = DesignStatus.FAILED
...
def generate_from_audio(
    *,
    ...
    transcript = transcriber.transcribe(
        audio_file.read(), filename=audio_file.name
    )
...
def assistant_reply(
    *,
    ...
    try:
        ...
        Exception
    ):  # noqa: BLE001 — IA externa caída (429/cuota): responde el asistente mock
        if provider.name == "mock":
            raise
